...
<% 
	...
	String email_contacto = request.getParameter("email_contacto");
	...
	asistente.setTipoDocumento(tipoDocumento);
	asistente.setNumeroDocumento(documento);
	...
	asistente.setEmailsContacto(email_contacto);
	asistente.setTelefono(telefono);
	asistente.setDireccion(direccion);

	String msg = facade.editarAsistente(asistente);
...
%>
    ...
    <div class="col-8 row p-0 m-1 " style="background-color:#45BDEE;background-image: url(imagenes/textura5mas1.png); background-blend-mode:overlay; ">
      ...
      <div class="titulos p-0 m-0 col-8 col-md-9" style="text-align: center; background-color:#FFFFFF;"><br><br><span
          style="font-size: 1.5em">Edit personal information</span><br><br></div>
      <a name="Register"></a>
