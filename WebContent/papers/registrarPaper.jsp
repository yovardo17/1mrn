...
<% 
	try{
		...
		List<Paper> papers = facade.getPapers(asistente);
  	...
  	<body>
  		...
  		<section id="tres" class="container-fluid row p-0 m-0 "> 
		    ...
		    <div class="col-12 row p-0 m-1 " style="background-color:#45BDEE;background-image: url(../imagenes/textura5mas1.png); background-blend-mode:overlay; ">
		      ...
		      <i class="fas fa-file-alt fa-4x" style="color:rgb(42, 146, 187)"></i></div>
		      ...
		      <div class="p-0 p-sm-2 p-md-5" >
		        ...
		        <div class="row p-0 mt-5">
		          <div class=" borde-tabla2 fonto-tabla">
		    			...
		    			%>
		    			<form id="frmRegistro" name="frmRegistro" action="guardarPaper.jsp" method="post">
                  					...
                  					<div class="card bg-light mb-3">
						            	...
						            	<div class="card-body">
										  <div class="form-group">
										    ...
										    <input type="text" id="titulo_en" name="titulo_en" required="required" placeholder="English title" class="form-control"/>
										  </div>
										  <div class="form-group">
										    <label for="numeroDocumento">Spanish Title: *</label>
										    <input type="text" id="titulo_es" name="titulo_es" required="required" placeholder="Spanish title" class="form-control"/>
										  </div>
										  <div class="form-group">
						...
						%>		           		
							...
							%>		           		
	                  			...
	                  			<div class="tab-pane fade" id="files" role="tabpanel" aria-labelledby="files-tab">
	                  				...
	                  				<div class="card">
							            <div class="card-header">
							              <h3 class="card-title">If you are sure to send your abstract, please click in the Submit button.</h3>
							            </div>
							            <div class="card-body">
									        <div class="form-group" align="center">
									        	<a href="#" class="btn btn-lg btn-primary" onclick="siguienteSeccion(2)">Back</a>
												<a href="../bienvenida.jsp" class="btn btn-lg btn-primary">Cancel</a>
												<button type="button" class="btn btn-lg btn-primary" onclick="enivarPaper()">Submit Abstract</button>
											</div>
										</div>
									</div>
	                  			</div>	                  			              			
                  	...
                  	%>              
                  		<div class="alert alert-info" role="alert">
							You can only send five abstracts and two as a Speaker
						</div>
						<br>
				        <div class="form-group" align="center">				        	
							<a href="../bienvenida.jsp" class="btn btn-lg btn-primary">Back</a>							
						</div>
