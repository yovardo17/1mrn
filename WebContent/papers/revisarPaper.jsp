...
<% 
	String titulo_en = request.getParameter("titulo");
	...
	String  rta = facade.revisarPaper(Integer.parseInt(id),Short.parseShort(tipo), Short.parseShort(estado), observaciones);  
	
	if (rta.equals("")) {
		msg = "Successful Review";
	}
    else msg = rta;
	
	String filtro = (String) session.getAttribute("filtro");
	String idPaper = (String)session.getAttribute("id_paper");
	String idEstado = (String)session.getAttribute("idEstado");
	String idTopico = (String)session.getAttribute("idTopico");
	String idTipo = (String)session.getAttribute("idTipo");
%>
  	...
  	<section id="tres" class="container-fluid row p-0 m-0 "> 
		    ...
		    <div class="col-12 row p-0 m-1 " style="background-color:#45BDEE;background-image: url(../imagenes/textura5mas1.png); background-blend-mode:overlay; ">
		      ...
		      <div class="titulos p-0 m-0 col-8 col-md-9" style="text-align: center; background-color:#FFFFFF;"><br><br><span
		          style="font-size: 1.5em">Review abstracts</span><br><br></div>
		      <a name="Register"></a>
		      <div class="p-0 p-sm-2 p-md-5" >
		        ...
		        <div class="row p-0 mt-5">
		          <div class=" borde-tabla2 fonto-tabla">
				            ...
				            <div class="card-body">
					            ...
					            <tbody>
					              ...
					              <tr>
					                ...
					                <td>
					                	<%= facade.getTipoPresentacion(Integer.parseInt(tipo)).getNombre() %>
					                </td>
					              </tr>
					              <tr>
					                <td>Status:</td>
					                <td><%= facade.getEstadoPaper(Short.parseShort(estado)).getNombre()%>
					                </td>
					              </tr>
					           </tbody>
					           </table>
					...
					%>
								<br>
								<form action="../bienvenida.jsp" name="frmEnviar" id="frmEnviar" method="post">
									<input type="hidden" id="filtro" name="filtro" class="form-control" value="<%= filtro %>">
									<input type="hidden" id="id" name="id" class="form-control" value="<%= idPaper %>">
									<input type="hidden" id="estado" name="estado" class="form-control" value="<%= idEstado %>">
									<input type="hidden" id="topico" name="topico" class="form-control" value="<%= idTopico %>">
									<input type="hidden" id="tipoPresentacion" name="tipoPresentacion" class="form-control" value="<%= idTipo %>">
