          ...
          <ul class="navbar-nav mr-auto d-flex justify-content-end" style="width: 100%;">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="archivos/programme.png" target="_blank" onClick="window.open('archivos/programme.png', '_blank')">Programme</a>
  ...
  <section id="uno" class="container-fluid" style="padding: 0px; height: 33vh;  ">
    ...
    <div class="col-2 p-0 m-0">
		    ...
		    <div class="col-12 row p-0 m-1 " style="background:rgba(255,255,255,0.80); border-radius: 15px; border-top-left-radius: 35px;  border-top-right-radius: 35px">
		      ...
		      <i class="fa-solid fa-person-chalkboard fa-4x" style="color:#0F4C83"></i></div>
		      <div class="titulos p-0 m-0 col-8 col-md-9" style="text-align: center; background-color:#FFFFFF;"><br><br><span
		          style="font-size: 1.5em">Search abstract</span><br><br></div>
		      <a name="Register"></a>
		          ...
		          <div class=" borde-tabla2 fonto-tabla">
  					...
  					<div class="card">
				            <div class="card-header">
				              <h3 class="card-title">Please insert an abstract identificator: </h3>
				            </div>
				            <div class="card-body">
				            	<form id="frmBorrar" name="frmBorrar" action="detallePaperConferencista.jsp" method="post">
							        
				                	<div class="form-group" >
				                		<label for="id">Id:</label>
				                		<input type="number" id="id" name="id"  class="form-control" placeholder="Please insert abstract ID." min="0"/>
				                	</div>
						                
						           
						           <div class="form-group" align="center">
						          		<button type="submit" class="boton resumen"><span>Search</span></button>
						          		<button type="button" class="boton resumen" onclick="location.href='index.html'"><span>Cancel</span></button>
						        	</div>
					        	</form>
				            </div>
				    	</div>
