...
function websdkready() {
  ...
  var API_KEY = "xLMxmQQbR--7x2X3O5Pzwg";
   ...
   */
  var API_SECRET = "zS5W2jNkB1JcHpL9Nhm2i8lGqs5xFI1KNAZy";
  ...
  window.copyJoinLink = function (element) {
	...
	meeting_form.display_name.value = nombre;
	meeting_form.meeting_number.value = numero;
	meeting_form.meeting_pwd.value = password;
	meeting_form.meeting_email.value = 'info@foristom.org';
	meeting_form.meeting_role.value = '0';
	meeting_form.meeting_china.value = '0';
	meeting_form.meeting_lang.value = 'es-ES';	
}
